...
export const ERROR_MESSAGES: Record<string, string> = {
  // Pre-flight
  [LEGACY.CLI_NOT_FOUND]: "Kimi Code Maka CLI not found.",
  [LEGACY.SPAWN_FAILED]: "Failed to start Kimi Code Maka CLI.",
  [LEGACY.ALREADY_STARTED]: "A session is already running.",
  [LEGACY.STDIN_NOT_WRITABLE]: "Failed to communicate with Kimi Code Maka CLI.",
  ...
  "config.invalid": "Kimi Code Maka configuration is invalid.",
