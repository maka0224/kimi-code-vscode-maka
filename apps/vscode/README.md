...
- 本分支使用独立版本号，从 `0.1.0` 开始；与上游的对应关系记录在扩展内的 CHANGELOG 中，后续按需跟进上游更新。
...
- 源码与问题反馈：[GitHub 仓库](https://github.com/maka0224/kimi-code-vscode-maka)
- 更新日志：见扩展内的 CHANGELOG

## 许可证

[MIT](https://github.com/maka0224/kimi-code-vscode-maka/blob/main/LICENSE)
